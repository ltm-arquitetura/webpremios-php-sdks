...
/**
 * EndereoApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface EndereoApiInterface
{
     ...
     *
     * @param  string $zip_code  CEP (required)
     *
     * @return ZipCodeAddress  Operação realizada com sucesso.
     *
