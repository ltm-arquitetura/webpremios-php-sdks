...
/**
 * SKUApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface SKUApiInterface
{
     ...
     *
     * @param  string $id  Identificador do SKU (required)
     * @param  string $vendor_id  Identificador do vendor (required)
     * @param  string $original_id  Identificador do SKU no vendor (required)
     *
     * @return Availability  Operação realizada com sucesso.
     *
