...
/**
 * ProdutoApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface ProdutoApiInterface
{
     ...
     *
     * @param  string $product_sku_id  Identificador do SKU (required)
     * @param  string $_fields  Filtro para reduzir o número de atributos a ser retornado para esse recurso. Ex. _fields&#x3D;field1,field2,...fieldN (optional)
     *
     * @return ProductDetail  Operação realizada com sucesso.
     *
