...
/**
 * VitrineApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface VitrineApiInterface
{
     ...
     *
     * @param  string $showcase_id  Identificador da vitrine (required)
     * @param  int $_offset   (optional, default to 0)
     *
     * @return Showcase  Operação realizada com sucesso.
     *
