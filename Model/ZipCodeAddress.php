...
/**
 * Class representing the ZipCodeAddress model.
 *
 * @package Swagger\Server\Model
 * @author  Swagger Codegen team
 */
class ZipCodeAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $_name = 'zipCodeAddress';
    ...
    protected static $_attributes = [
        'street_type' => ['streetType', 'string', null, 'setStreetType', 'getStreetType'],
     ...
     * Sets street_type.
     *
     * @param string|null $street_type  Tipo do logradouro ex: Rua, Avenida
     *
     * @return $this
     */
