...
/**
 * Class representing the ProductBrand model.
 *
 * @package Swagger\Server\Model
 * @author  Swagger Codegen team
 */
class ProductBrand implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $_name = 'productBrand';
     ...
     * Sets id.
     *
     * @param string|null $id  Identificador da marca
     *
     * @return $this
     */
     ...
     * Sets name.
     *
     * @param string|null $name  Nome da marca
     *
     * @return $this
     */
