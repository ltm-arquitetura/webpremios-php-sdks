...
/**
 * Class representing the ParticipantAdd model.
 *
 * @package Swagger\Server\Model
 * @author  Swagger Codegen team
 */
class ParticipantAdd implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $_name = 'participantAdd';
     ...
     * Sets username.
     *
     * @param string $username  Login do participante
     *
     * @return $this
     */
